...
function displayVectors(variables, terminales, originalContent) {
    ...
    fileContentDiv.innerHTML =
      '<div class="vector" style="background-color: rgb(255, 255, 153);"><h2>Contenido Original:</h2><pre>' +
      originalContent +
      '</pre></div>' +
      '<div class="vector" style="background-color: rgb(255, 255, 153);"><h2>Variables:</h2><pre>' +
      variables.join("\n") +
      "</pre></div>" +
      '<div class="vector" style="background-color: rgb(255, 255, 153);"><h2>Terminales:</h2><pre>' +
      terminales.join("\n") +
      "</pre></div>";
